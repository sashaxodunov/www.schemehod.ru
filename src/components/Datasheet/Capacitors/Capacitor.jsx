  ...
  const items = [
    {
      ...
      href: '/Datasheet/capacitors/ceramic',
    ...
    },
    {
      ...
      href: '/Datasheet/capacitors/film',
    ...
    },
    {
      ...
      href: '/Datasheet/capacitors/glass',
    ...
    },
    {
      ...
      href: '/Datasheet/capacitors/micaceous',
    ...
    },
    {
      ...
      titleText:
        'Это тип конденсатора, в котором в качестве одной из обкладок используется электролит для увеличения ёмкости.',
      href: '/Datasheet/capacitors/electrolytic',
    ...
    },
    {
      ...
      titleText:
        'Подтип электролитического конденсатора, изготавливается из металлического тантала, выполняющего роль анода, покрытого изолирующим оксидным слоем.',
      href: '/Datasheet/capacitors/tantalum',
    ...
    },
    {
      ...
      titleText:
        'Это тип конденсатора, у которого ёмкость можно изменять в определённых пределах для точной настройки параметров цепи.',
      href: '/Datasheet/capacitors/substructures',
    ...
    },
    {
      ...
      titleFrom: 'Варикапы',
      titleText:
        'Сопротивление которого изменяется в зависимости от освещённости.',
      href: '/Datasheet/capacitors/varicaps',
        ...
        <div className="container">
          ...
          <div className="section-datasheet-desc">
            <p>
              ...
              энергию в виде электрического поля между двумя проводящими
              пластинами, разделёнными диэлектриком (изоляционным материалом).
              Главная особенность конденсатора — способность «запоминать» заряд
              и быстро отдавать его обратно в цепь. Это свойство делает
              конденсаторы полезными для сглаживания колебаний напряжения,
              фильтрации сигналов, временных задержек и накопления энергии для
              кратковременной подзарядки устройств.
            </p>
          </div>
