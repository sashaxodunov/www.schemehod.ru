        ...
        <div className="container">
          ...
          <div className="ruMC">
            ...
            <div className="ruMC--img__box">
              <img
                className="ruMC--img"
                src="/images/Datasheet/Microchips/ruMC/К145/K145IK1807/pug.1.png"
                alt=""
              />
            ...
            <div className="ruMC--img__box">
              <img
                className="ruMC--img"
                src="/images/Datasheet/Microchips/ruMC/К145/K145IK1807/pug.2.png"
                alt=""
              />
              <div className="ruMC--img__text">
            ...
            <div className="ruMC--img__box">
              <img
                className="ruMC--img"
                src="/images/Datasheet/Microchips/ruMC/К145/K145IK1807/pug.3.png"
                alt=""
              />
              <div className="ruMC--img__text">
